...
//
// cd ../cpp/build
// nvcc -w -std=c++11 --expt-extended-lambda -gencode arch=compute_70,code=sm_70 ../tests/strstats.cu -L. -lNVStrings -o strstats --linker-options -rpath,.:
//
