...
//
// cd ../cpp/build
// nvcc -w -std=c++11 --expt-extended-lambda -gencode arch=compute_70,code=sm_70 ../tests/catcopy.cu -L. -lNVStrings -lNVCategory -o catcopy --linker-options -rpath,.:
//
