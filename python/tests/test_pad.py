...
def test_pad():
    ...
    got = strs.pad(5)
    expected = ['hello', 'there', 'world', ' 1234', '-1234', None, 'accént',
                '     ']
    assert_eq(got, expected)

    # pad right only
    got = strs.pad(7, 'right')
    expected = ['hello  ', 'there  ', 'world  ', '1234   ', '-1234  ', None,
                'accént ', '       ']
    assert_eq(got, expected)
...
def test_zfill():
    strs = nvstrings.to_device(
        ["hello", "there", "world", "1234", "-1234", None, "accént", ""])
    got = strs.zfill(6)
    expected = ['0hello', '0there', '0world', '001234', '-01234', None,
                'accént', '000000']
    assert_eq(got, expected)
...
def test_repeat():
    strs = nvstrings.to_device(
        ["hello", "there", "world", "1234", "-1234", None, "accént", ""])
    got = strs.repeat(6)
    expected = ['hellohellohellohellohellohello',
                'theretheretheretheretherethere',
                'worldworldworldworldworldworld', '123412341234123412341234',
